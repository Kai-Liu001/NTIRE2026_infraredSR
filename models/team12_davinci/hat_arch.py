...
class HAB(nn.Module):
    ...
    def __init__(self,
        ...
        self.my_module_mona_1 = Mona(dim, 8)
        self.my_module_mona_2 = Mona(dim, 8)
    ...
    def forward(self, x, x_size, rpi_sa, attn_mask):
        ...
        x = self.my_module_mona_1(x, (h, w))

        x = x + self.drop_path(self.mlp(self.norm2(x)))

        x = self.my_module_mona_2(x, (h, w))

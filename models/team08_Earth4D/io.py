...
from models.team08_IRSR.model import IRSR
...
def main(model_dir, input_path, output_path, device=None):
    utils_logger.logger_info("NTIRE2026-InfraredSRx4", log_path="NTIRE2026-InfraredSRx4.log")
    logger = logging.getLogger("NTIRE2026-InfraredSRx4")

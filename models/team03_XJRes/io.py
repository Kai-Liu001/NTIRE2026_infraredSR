...
from models.team04_I2WM_JNU.basicsr.archs.mambairv2_arch import MambaIRv2
from models.team04_I2WM_JNU.basicsr.archs.hat_arch import HATLocal
...
def model_ensemble(save_dir):
    ...
    dir2 = os.path.join(save_dir, '02_HAT')
...
def main(model_dir, input_path, output_path, device=None):
    utils_logger.logger_info("NTIRE2026_infraredSR", log_path="NTIRE2026_infraredSR.log")
    logger = logging.getLogger("NTIRE2026_infraredSR")
    ...
    # output_path1 = output_path.replace('01_PMELSR', '01_MambaIRv2')
    ...
    output_path2 = os.path.join(output_path, '02_HAT')
